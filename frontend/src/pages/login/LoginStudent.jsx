...
import app from "../../firebase/firebaseconfig"; // make sure firebase is initialized
      ...
      <div className="w-full max-w-md bg-white p-8 rounded-2xl shadow-lg">
        ...
        <div className="mb-6">
          <button
            ...
            disabled={loading}
            className="w-full bg-red-500 text-white py-3 px-4 rounded-lg hover:bg-red-600 disabled:opacity-50 flex items-center justify-center gap-2 transition-colors"
          >
